...
- שאריות [פטריות](mushrooms.md)/חומרי הדברה: בעגבניות גידול אינטנסיבי עלול להוביל לשאריות חומרי הדברה; בחירה בעגבניות אורגניות או שטיפה טובה מורידה סיכון זה.
...
- שיפור ספיגת הלקופין: להכין עגבניות מבושלות (רוטב, מרק) עם מעט שמן ([שמן זית](olive-oil.md)) כדי להגביר את התועלת הבריאותית.
