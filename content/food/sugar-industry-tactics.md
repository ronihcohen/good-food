...
סוכר אינו סתם "דלק". צריכת סוכר, ובעיקר פרוקטוז (שנמצא ב[סירופ תירס](corn-syrup.md) עתיר פרוקטוז ובסוכר לבן), מפעילה במוח את "מרכז התגמול" (Nucleus Accumbens) באופן הדומה לסמים ממכרים:
